...
export const SocialLinks = () => {
  ...
  const hasSocialLinks = facebookUrl || linkedinUrl || tiktokUrl;
      ...
      <div className="flex gap-4">
        {facebookUrl && (
          <a
            ...
            className="w-12 h-12 rounded-full bg-foreground flex items-center justify-center hover:bg-primary transition-colors"
            aria-label="Facebook"
          >
