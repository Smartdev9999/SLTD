...
const featureKeys = ['osha', 'certified', 'flexible', 'customized', 'bilingual', 'digital'] as const;
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 bg-primary text-primary-foreground p-6 rounded-lg shadow-xl">
              ...
              <div className="text-primary-foreground/80 text-sm">{t('hero.stats.experience')}</div>
            </div>
          </div>
